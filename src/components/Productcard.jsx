  ...
  return (
    <div className="bg-white/10 p-4 shadow-lg text-black shadow-black/30 rounded-xl backdrop-blur-md h-full hover:scale-105 transition border border-black/30 flex flex-col">
      ...
      <button
        ...
        className="mt-3 w-full py-2 text-black active:scale-95 font-semibold border-black shadow-md shadow-black/30 hover:scale-105 rounded-full bg-yellow-400 hover:text-white transition"
      >
        Add to Cart
      </button>
    </div>
